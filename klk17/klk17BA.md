...
Kısa yanıtlı soruların yanıtı bir kelime, bir sembol, bir rakam, bir ifade ya da basit yapıda bir cümle (Atılgan, Kan, ve Aydın, 2017:167) olabileceği gibi bir cümle ile bir paragraf arasında da olabilir (Burrows, Gurevych ve Stein, 2015). 
...
II.  Değişkenlere dayalı ebep-sonuç belirtmez.  
III. Artı sonsuz ile eksi sonsuz arasında değer alabilir. 
